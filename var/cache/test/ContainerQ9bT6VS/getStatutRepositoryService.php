...
// Returns the private 'App\Repository\StatutRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/StatutRepository.php';

return $this->privates['App\\Repository\\StatutRepository'] = new \App\Repository\StatutRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
